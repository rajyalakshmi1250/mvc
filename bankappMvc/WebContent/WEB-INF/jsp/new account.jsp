...
<div class="form-group">
    ...
    <form action="/bankappmvc/app/bank/add" method = "post">
        Customer name:<br>
        <input type="text" name="Customer name" ><br><br>
       
         Account Type:<br>
       <select class="" name = "Account Type">
        ...
        <input type="number" name="Account Balance" ><br><br>
       <br><br> <button><input type="submit" value="open New Account"></button><br>
      </form>
</div>
</body>
</html>